...
| 1. Нажать кнопку `Sign In`       | Получаем сообщение: "*Invalid username or password.*"|   |
...
| Перейти по ссылке http://localhost:8080/auth/realms/Demo/account |Открывается страница авторизации|
| **Шаги**       | **Ожидаемый результат**           | **Фактический результат**  |
| 1. В поле `Username or email` ввести логин пользователя|Отображается логин пользователя в поле|   |
| 2. В поле `Password` ввести пароль пользователя|В поле отображается, что пароль скрыт ****|В DOM пароль видим ![img.png](img.png)|
| 3. Нажать кнопку `Sign In`       | Отображается страница редактирования аккаунта|   |
| **Постусловия**| **Ожидаемый результат**|**Фактический результат**|
| Закрыть браузер       |Браузер закрыт            |   |
...
| 1. В поле `Username or email` ввести логин пользователя|Отображается логин пользователя в поле|   |
| 2. В поле `Password` ввести пароль пользователя|В поле отображается, что пароль скрыт ****|В DOM пароль видим ![img.png](img.png)|
| 3. Нажать кнопку `Sign In`       | Получаем сообщение: "*Invalid username or password.*"|   |
| **Постусловия**| **Ожидаемый результат**|**Фактический результат**|
| Закрыть браузер       |Браузер закрыт            |   |
...
| Перейти по ссылке http://localhost:8080/auth/realms/Demo/account |Открывается страница авторизации|
| **Шаги**       | **Ожидаемый результат**           | **Фактический результат**  |
| 1. Перейти по ссылке `Register`|Отображается страница ввода регистрационных данных|   |
| 2. В поле `First name` ввести имя пользователя|Отображается имя пользователя в поле|   |
| 3. В поле `Last name` ввести фамилию пользователя|Отображается фамилия пользователя в поле|   |
| 4. В поле `Email` ввести эл.почту пользователя|Отображается email пользователя в поле|   |
| 5. В поле `Username` ввести логин пользователя|В поле отображается логин пользователя||
| 6. В поле `Password` ввести пароль пользователя|В поле отображается, что пароль скрыт ****|В DOM пароль видим ![img.png](img.png)|
| 7. В поле `Confirm password` ввести пароль пользователя|В поле отображается, что пароль скрыт ****|В DOM пароль видим ![img.png](img.png)|
| 8. Нажать кнопку `Register` |Отображается страница редактирования аккаунта|   |
| **Постусловия**| **Ожидаемый результат**|**Фактический результат**|
| Закрыть браузер       |Браузер закрыт            |   |
